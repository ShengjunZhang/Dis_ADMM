...
plot(k, plot_non_linearized_admm, '-', 'LineWidth', 1.5); hold on;
plot(k, plot_linearized_admm, '-.', 'LineWidth', 1.5); hold on;
% plot(k, plot_first_order, ':', 'LineWidth', 2); hold on;
plot(k, plot_qu_li, '--', 'LineWidth', 1.5); hold on;
plot(k, plot_Prox_PDA, '-', 'LineWidth', 1.5); hold on;
plot(k, plot_Prox_GPDA, '-', 'LineWidth', 1.5); hold on;
set(gca,'FontSize', 10);
set(gca, 'YScale', 'log');
...
legend({'Algorithm 3.2',...
        'Algorithm 3.3', ...
       'DGTA',...
       'Prox-PDA', ...
       'Prox-GPDA',}, ...
       'Interpreter', 'latex', 'FontSize', 11, 'FontWeight','bold');   
 saveas(gcf,'admm_dpr_thesis','epsc');  
% figure(2);
% 
% k = 1:iterations;
% 
